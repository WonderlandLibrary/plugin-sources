package ai.rippedthisofsomeguy.gui;

import ai.rippedthisofsomeguy.gui.buttons.SGButton;
import ai.rippedthisofsomeguy.gui.item.ItemBuilder;
import ai.rippedthisofsomeguy.gui.menu.SGMenuListener;
import ai.rippedthisofsomeguy.gui.menu.SGOpenMenu;
import ai.rippedthisofsomeguy.gui.pagination.SGPaginationButtonBuilder;
...
public class GuiManager {
     ...
     * this class by calling {@link #create(String, int)} on the static {@link GuiManager} field.
     *
    ...
    /**
     * @see GuiManager#blockDefaultInteractions
     *
    ...
    /**
     * Returns the value of {@link GuiManager#blockDefaultInteractions} for this plugin.
     *
    ...
    /**
     * @see GuiManager#enableAutomaticPagination
     *
    ...
    /**
     * Returns the value of {@link GuiManager#enableAutomaticPagination} for this plugin.
     *
    ...
    /**
     * @see GuiManager#defaultPaginationButtonBuilder
     *
