...
public abstract class RotationCheck extends Check {
    public RotationCheck(PlayerData playerData, String name, String desc, ViolationHandler violationHandler, Category category, SubCategory subCategory, int falseProbability) {
