...
public class MathHelper
{
    ...
    public static float cos(final float p_76134_0_) {
        return MathHelper.SIN_TABLE[(int)(p_76134_0_ * 10430.378f + 16384.0f) & 0xFFFF];
    }
    ...
    public static float wrapAngleTo180_float(float yaw) {
        yaw %= 360.0f;
        if (yaw >= 180.0f) {
            yaw -= 360.0f;
        }
    ...
    public static long func_180186_a(final Vec3i p_180186_0_) {
        return func_180187_c(p_180186_0_.getX(), p_180186_0_.getY(), p_180186_0_.getZ());
    }
    
    public static long func_180187_c(final int p_180187_0_, final int p_180187_1_, final int p_180187_2_) {
        long var3 = (long)(p_180187_0_ * 3129871) ^ p_180187_2_ * 116129781L ^ (long)p_180187_1_;
